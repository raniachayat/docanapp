...
def main():
    ...
    if not st.session_state.logged_in:
        ...
        # Select cancer type outside form so mutation dropdowns update live
        ...
        with st.form("clinical_form"):
            ...
            mutation_1 = st.selectbox("Mutation 1", mutation_options)
            mutation_2 = st.selectbox("Mutation 2", ["None"] + mutation_options)
